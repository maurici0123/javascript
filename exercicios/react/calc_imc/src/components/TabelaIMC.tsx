...
export default function TabelaIMC(props: TabelaIMCProps) {
    return (
        <div className="mx-2 mb-2">
            <div className="flex">
                <div className="w-1/2 border p-1 text-center font-semibold">Classificação</div>
                <div className="w-1/2 border p-1 text-center font-semibold">IMC</div>
            </div>
            <div className={"flex " + (props.imc < 18.5 ? 'destaque' : '')}>
                <div className="w-1/2 border p-1">Abaixo do peso</div>
                <div className="w-1/2 border p-1">Abaixo de 18.5</div>
            </div>
            ...
            <div className={"flex " + (props.imc >= 25 && props.imc < 30 ? 'destaque' : '')}>
                <div className="w-1/2 border p-1">Sobre peso</div>
